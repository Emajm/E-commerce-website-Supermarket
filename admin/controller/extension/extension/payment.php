...
class ControllerExtensionExtensionPayment extends Controller {
    ...
    $data['french_solution'] = $this->language->get('french_solution');
    $data['free_french_solution'] = $this->language->get('free_french_solution');
    $data['link_french_market'] = $this->language->get('link_french_market');
    $data['link_french_editor'] = $this->language->get('link_french_editor');
    $data['text_free_vad'] = $this->language->get('text_free_vad'); 
    $data['text_free_all_bank'] = $this->language->get('text_free_all_bank');
    $data['text_free_for'] = $this->language->get('text_free_for');     
