...
class ControllerExtensionPaymentSystempay extends Controller
{
    protected $error = '';
    protected $name;
    protected $prefix;
    ...
    public function __construct($params)
    {
        ...
        require_once(DIR_SYSTEM . 'library/systempay/tools.php');
        $this->plugin_features = SystempayTools::$plugin_features;
    }
    ...
    protected function getFormData()
    {
        ...
        $data['text_payment_systempay_yes'] = $this->language->get('text_payment_systempay_yes');
        $data['text_payment_systempay_no'] = $this->language->get('text_payment_systempay_no');
        $data['text_payment_systempay_test'] = $this->language->get('text_payment_systempay_test');
        $data['text_payment_systempay_production'] = $this->language->get('text_payment_systempay_production');
        $data['text_payment_systempay_default'] = $this->language->get('text_payment_systempay_default');
        $data['text_payment_systempay_automatic'] = $this->language->get('text_payment_systempay_automatic');
        $data['text_payment_systempay_manual'] = $this->language->get('text_payment_systempay_manual');

        $data['section_payment_systempay_module_info'] = $this->language->get('section_payment_systempay_module_info');
        $data['section_payment_systempay_payment_access'] = $this->language->get('section_payment_systempay_payment_access');
        $data['section_payment_systempay_payment_page'] = $this->language->get('section_payment_systempay_payment_page');
        $data['section_payment_systempay_selective_3ds'] = $this->language->get('section_payment_systempay_selective_3ds');
        $data['section_payment_systempay_return_to_shop'] = $this->language->get('section_payment_systempay_return_to_shop');
        $data['section_payment_systempay_display_options'] = $this->language->get('section_payment_systempay_display_options');
        $data['section_payment_systempay_restrictions'] = $this->language->get('section_payment_systempay_restrictions');
        $data['section_payment_systempay_orders'] = $this->language->get('section_payment_systempay_orders');
        $data['section_payment_systempay_notifications'] = $this->language->get('section_payment_systempay_notifications');

        $data['entry_payment_systempay_developed_by'] = $this->language->get('entry_payment_systempay_developed_by');
        $data['entry_payment_systempay_contact_email'] = $this->language->get('entry_payment_systempay_contact_email');
        $data['entry_payment_systempay_contrib_version'] = $this->language->get('entry_payment_systempay_contrib_version');
        $data['entry_payment_systempay_gateway_version'] = $this->language->get('entry_payment_systempay_gateway_version');

        $data['entry_payment_systempay_url_check'] = $this->language->get('entry_payment_systempay_url_check');
        $data['desc_payment_systempay_url_check'] = $this->language->get('desc_payment_systempay_url_check');

        require_once(DIR_SYSTEM . 'library/systempay/api.php');
        ...
        foreach (SystempayApi::getSupportedLanguages() as $code => $label) {
            $data[$this->prefix . $this->name . '_language_options'][$code] = $this->language->get('text_payment_systempay_' . strtolower($label));
        }

        // use supported API card types
        $data[$this->prefix . $this->name . '_payment_card_options'] = SystempayApi::getSupportedCardTypes();
        ...
        $data['tab_payment_systempay_general'] = $this->language->get('tab_payment_systempay_general');
        $data['tab_payment_systempay_specific'] = $this->language->get('tab_payment_systempay_specific');
        $data['tab_payment_systempay_orders'] = $this->language->get('tab_payment_systempay_orders');
        ...
        $data[$this->prefix . 'systempay_notification_url'] = HTTP_CATALOG . 'index.php?route=extension/payment/systempay/callback';
        ...
        foreach ($this->configParams as $param) {
            ...
            // load language constants
            $data['entry_payment_systempay_' . $param] = $this->language->get('entry_payment_systempay_' . $param);
            $data['desc_payment_systempay_' . $param] = $this->language->get('desc_payment_systempay_' . $param);

            if (($param === 'sign_algo') && ! $this->plugin_features['shatwo']) {
                $data['desc_payment_systempay_' . $param] .= $this->language->get('desc_payment_systempay_sign_algo_details');
            }
        }
        ...
        $data['systempay_plugin_features'] = $this->plugin_features;
    ...
    protected function getDefaultValues()
    {
        ...
        $data[$this->prefix . $this->name . '_platform_url'] = 'https://paiement.systempay.fr/vads-payment/';
